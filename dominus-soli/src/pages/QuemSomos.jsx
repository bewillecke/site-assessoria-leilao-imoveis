...
export default function QuemSomos() {
  return (
    <>
      <Header />
      <Navbar />
      <section className="flex justify-center py-8 sm:py-12 md:py-16 lg:py-20 bg-white">
        <div className="flex flex-col md:flex-row gap-8 sm:gap-12 md:gap-16 lg:gap-32 max-w-6xl w-full px-4 sm:px-6">
          <div className="flex-1 flex flex-col items-center text-center gap-4 sm:gap-6 md:gap-8 lg:gap-12">
            <img src="/data/imagens/soraya.jpeg" alt="Soraya Willecke" className="w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 lg:w-52 lg:h-52 object-cover rounded-full mb-2 border-4 border-[#11397a]" />
            <h3 className="text-[#11397a] text-xl sm:text-2xl md:text-3xl font-bold mb-2">Soraya Willecke</h3>
            <p className="text-[#11397a] text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed">
          ...
          <div className="flex-1 flex flex-col items-center text-center gap-4 sm:gap-6 md:gap-8 lg:gap-12">
            <img src="/data/imagens/ana.jpeg" alt="Ana Bek" className="w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 lg:w-52 lg:h-52 object-cover rounded-full mb-2 border-4 border-[#11397a]" />
            <h3 className="text-[#11397a] text-xl sm:text-2xl md:text-3xl font-bold mb-2">Ana Bek</h3>
            <p className="text-[#11397a] text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed">
