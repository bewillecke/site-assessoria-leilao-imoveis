  ...
  return (
    <footer className="bg-[#11397a] text-white mt-8">
      <div className="max-w-6xl mx-auto px-4 py-10">
        ...
        <ul className="flex items-center justify-center gap-14 mb-8">
          ...
          <li className="flex flex-col items-center">
            ...
            >
              <span
                className="w-12 h-12 rounded-full shadow-lg ring-2 ring-white/20 grid place-items-center transition-transform group-hover:-translate-y-0.5"
          ...
          <li className="flex flex-col items-center">
            <a
              ...
              title="Facebook"
            >
              <span className="w-12 h-12 rounded-full shadow-lg ring-2 ring-white/20 grid place-items-center bg-[#1877F2] transition-transform group-hover:-translate-y-0.5">
                <svg
                  viewBox="0 0 24 24"
                  className="w-6 h-6 text-white"
                  fill="currentColor"
          ...
          <li className="flex flex-col items-center">
            <a
              ...
              title="Whatsapp"
            >
              <span className="w-12 h-12 rounded-full shadow-lg ring-2 ring-white/20 grid place-items-center bg-[#25D366] transition-transform group-hover:-translate-y-0.5">
                <svg
                  viewBox="0 0 24 24"
                  className="w-6 h-6 text-white"
                  fill="currentColor"
