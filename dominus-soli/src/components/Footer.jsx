export default function Footer() {
  ...
  <ul className="flex items-center justify-center gap-6 sm:gap-12 md:gap-24 lg:gap-36 mb-8">
          ...
          <li className="flex flex-col items-center">
            ...
            >
              ...
              <span className="text-sm sm:text-base lg:text-lg font-medium mt-2">Instagram</span>
            </a>
          </li>
          ...
          <li className="flex flex-col items-center">
            ...
            >
              ...
              <span className="text-sm sm:text-base lg:text-lg font-medium mt-2">Facebook</span>
            </a>
          </li>
          ...
          <li className="flex flex-col items-center">
            ...
            >
              ...
              <span className="text-sm sm:text-base lg:text-lg font-medium mt-2">Whatsapp</span>
            </a>
          </li>
        </ul>
